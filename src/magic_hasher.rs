...
mod tests {
    ...
    #[test]
    fn hashing() {
        assert_eq!((0x008080808080807Eu64.wrapping_mul(MAGIC_NUMBERS_ROOK[7]) >> 52) | (0b111 << 12),
                   magic_hash_rook(0x008080808080807Eu64, 7) as u64);
